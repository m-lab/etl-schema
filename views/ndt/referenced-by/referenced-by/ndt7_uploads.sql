--
-- This filtered view, ndt7_uploads, is our current best understanding
-- of all representative MLab ndt7 upload data.  Rows have been
-- filtered to exclude non-representative tests but the schema is a
-- superset of the Standard Top-level Columns design.  Columns that
-- are not part of that design may be subject to breaking changes in
-- the future.
--
