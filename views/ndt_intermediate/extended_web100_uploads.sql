...
UnifiedUploadSchema AS (
  SELECT
    ...
    STRUCT (
      'extended_web100_uploads' AS viewSource,
      NDTprotocol,
      ClientMetadata,
      ServerMetadata,
      [ parser ] AS Sources
    ...
    STRUCT (
      ...
      raw.web100.snap.HCThruOctetsReceived < 8192 AS IsShort,
      measurement_duration < 9000.0 AS IsAborted,
      measurement_duration > 60000.0 AS IsHung,
