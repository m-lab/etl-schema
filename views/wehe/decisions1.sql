...
ON result.raw.userID = info.raw.userID AND CAST(result.raw.historyCount AS INT64) = CAST(info.raw.historyCount AS INT64) AND result.raw.testID = info.raw.testID
